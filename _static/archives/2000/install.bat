...
echo ! from drive A:  into a subdirectory mcpc2000 of your current directory.   !
...
echo ! See notes\util.html or judge\read.me if you need the details.          ! 
echo !                                                                        !
...
echo !                                                                        !
echo ! Open a web browser on mcpc2000\browse.html and you will have links to  !
...
echo !    judge\read.me         for ascii text version of util.html           ! 
