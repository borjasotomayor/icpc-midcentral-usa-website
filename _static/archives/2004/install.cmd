...
echo ! into a subdirectory mcpc2004 of your current directory.                  !
...
if "%1z" == "z" goto tryE
if not exist %1\mcpc2004\rootmark.txt goto badParam
xcopy %1\mcpc2004 mcpc2004\ /s
goto finish
...
echo !   %1
echo ! was not a directory containing subdirectory mcpc2004.                    !
...
:tryE
if not exist e:\mcpc2004\rootmark.txt goto tryD
xcopy e:\mcpc2004 mcpc2004\ /s
goto finish

:tryD
echo Not at E:\mcpc2004, trying D:
if not exist d:\mcpc2004\rootmark.txt goto tryC
xcopy d:\mcpc2004 mcpc2004\ /s
goto finish

:tryC
echo Not at D:\mcpc2004, trying C:
if not exist c:\mcpc2004\rootmark.txt goto tryF
xcopy c:\mcpc2004 mcpc2004\ /s
goto finish

:tryF
echo Not at C:\mcpc2004, trying F:
if not exist f:\mcpc2004\rootmark.txt goto tryG
xcopy f:\mcpc2004 mcpc2004\ /s
goto finish

:tryG
echo Not at F:\mcpc2004, trying G:
if not exist g:\mcpc2004\rootmark.txt goto failed
xcopy g:\mcpc2004 mcpc2004\ /s
goto finish
...
echo ! directory which DOES contain mcpc2004.                                   !
echo !--------------------------------------------------------------------------!
goto theEnd
...
echo !                                                                        !
echo ! Your site director should make sure that the compile and execute       !
echo ! lines in judge\j2.cmd are correct for your environment.                !
...
echo !                                                                        !
echo ! Open a web browser on mcpc2004\browse.html and you will have links to  !
