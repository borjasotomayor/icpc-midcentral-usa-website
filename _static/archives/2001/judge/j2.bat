...
rem set VCPPBASE="C:\Program Files\Microsoft Visual Studio\VC98

rem %VCPPBASE%\Bin\cl" /I%VCPPBASE%\include" /I%VCPPBASE%\ATL\include" /nologo /MLd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /FD /GZ /c %2.%3

rem %VCPPBASE%\Bin\link" %2.obj /nologo /pdb:none /LIBPATH:%VCPPBASE%\lib"  /subsystem:console
