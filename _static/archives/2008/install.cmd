...
echo ! into a subdirectory mcpc2008 of your current directory.                  !
...
if "%1z" == "z" goto tryE
if not exist %1\mcpc2008\rootmark.txt goto badParam
xcopy %1\mcpc2008 mcpc2008\ /s
goto finish
...
echo !   %1
echo ! was not a directory containing subdirectory mcpc2008.                    !
...
:tryE
if not exist e:\mcpc2008\rootmark.txt goto tryD
xcopy e:\mcpc2008 mcpc2008\ /s
goto finish

:tryD
echo Not at E:\mcpc2008, trying D:
if not exist d:\mcpc2008\rootmark.txt goto tryC
xcopy d:\mcpc2008 mcpc2008\ /s
goto finish

:tryC
echo Not at D:\mcpc2008, trying C:
if not exist c:\mcpc2008\rootmark.txt goto tryF
xcopy c:\mcpc2008 mcpc2008\ /s
goto finish

:tryF
echo Not at C:\mcpc2008, trying F:
if not exist f:\mcpc2008\rootmark.txt goto tryG
xcopy f:\mcpc2008 mcpc2008\ /s
goto finish

:tryG
echo Not at F:\mcpc2008, trying G:
if not exist g:\mcpc2008\rootmark.txt goto failed
xcopy g:\mcpc2008 mcpc2008\ /s
goto finish
...
echo ! directory which DOES contain mcpc2008.                                   !
echo !--------------------------------------------------------------------------!
goto theEnd
...
echo !                                                                        !
echo ! Open a web browser on mcpc2008\browse.html and you will have links to  !
