...
echo ! into a subdirectory mcpc2011 of your current directory.                  !
...
if "%1z" == "z" goto tryE
if not exist %1\mcpc2011\rootmark.txt goto badParam
xcopy %1\mcpc2011 mcpc2011\ /s
goto finish
...
echo !   %1
echo ! was not a directory containing subdirectory mcpc2011.                    !
...
:tryE
if not exist e:\mcpc2011\rootmark.txt goto tryD
xcopy e:\mcpc2011 mcpc2011\ /s
goto finish

:tryD
echo Not at E:\mcpc2011, trying D:
if not exist d:\mcpc2011\rootmark.txt goto tryC
xcopy d:\mcpc2011 mcpc2011\ /s
goto finish

:tryC
echo Not at D:\mcpc2011, trying C:
if not exist c:\mcpc2011\rootmark.txt goto tryF
xcopy c:\mcpc2011 mcpc2011\ /s
goto finish

:tryF
echo Not at C:\mcpc2011, trying F:
if not exist f:\mcpc2011\rootmark.txt goto tryG
xcopy f:\mcpc2011 mcpc2011\ /s
goto finish

:tryG
echo Not at F:\mcpc2011, trying G:
if not exist g:\mcpc2011\rootmark.txt goto failed
xcopy g:\mcpc2011 mcpc2011\ /s
goto finish
...
echo ! directory which DOES contain mcpc2011.                                   !
echo !--------------------------------------------------------------------------!
goto theEnd
...
echo !                                                                        !
echo ! Open a web browser on mcpc2011\browse.html and you will have links to  !
