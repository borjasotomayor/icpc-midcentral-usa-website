...
rem vcpp.bat is a batch file in the judge directory for compiling Visual Studio C
rem You may choose to edit that file if you are using Visual C++
call ..\judge\vcpp %2 %3
goto check
:do_cpp
rem IS THE FOLLOWING C++ compiler LINE RIGHT FOR YOUR SYSTEM?
...
goto check
:do_pas
rem Fix the pascal compiler line to match your compiler
