...
cls
echo !----------------------------------------------------------!
echo ! There is no problem %0: SHOULD BE a,b,c,d,e,f,g OR h!
echo !----------------------------------------------------------!
goto done
:oops
cls
