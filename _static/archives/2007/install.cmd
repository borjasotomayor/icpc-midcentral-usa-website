...
echo ! into a subdirectory mcpc2007 of your current directory.                  !
...
if "%1z" == "z" goto tryE
if not exist %1\mcpc2007\rootmark.txt goto badParam
xcopy %1\mcpc2007 mcpc2007\ /s
goto finish
...
echo !   %1
echo ! was not a directory containing subdirectory mcpc2007.                    !
...
:tryE
if not exist e:\mcpc2007\rootmark.txt goto tryD
xcopy e:\mcpc2007 mcpc2007\ /s
goto finish

:tryD
echo Not at E:\mcpc2007, trying D:
if not exist d:\mcpc2007\rootmark.txt goto tryC
xcopy d:\mcpc2007 mcpc2007\ /s
goto finish

:tryC
echo Not at D:\mcpc2007, trying C:
if not exist c:\mcpc2007\rootmark.txt goto tryF
xcopy c:\mcpc2007 mcpc2007\ /s
goto finish

:tryF
echo Not at C:\mcpc2007, trying F:
if not exist f:\mcpc2007\rootmark.txt goto tryG
xcopy f:\mcpc2007 mcpc2007\ /s
goto finish

:tryG
echo Not at F:\mcpc2007, trying G:
if not exist g:\mcpc2007\rootmark.txt goto failed
xcopy g:\mcpc2007 mcpc2007\ /s
goto finish
...
echo ! directory which DOES contain mcpc2007.                                   !
echo !--------------------------------------------------------------------------!
goto theEnd
...
echo !                                                                        !
echo ! Open a web browser on mcpc2007\browse.html and you will have links to  !
